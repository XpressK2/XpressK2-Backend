...
ActiveRecord::Schema.define(version: 2020_12_25_153017) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["email", "trade_role", "name", "status"], name: "index_users_on_email_and_trade_role_and_name_and_status"
  end
